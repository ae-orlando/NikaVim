return {
  ...
  -- repeat those selections to select an outer text object.
  {
    ...
    opts = function()
      ...
      return {
        ...
        custom_textobjects = {
          ...
          g = NikaVim.mini.ai_buffer, -- buffer
    ...
    config = function(_, opts)
      ...
      NikaVim.on_load("which-key.nvim", function()
        vim.schedule(function()
          NikaVim.mini.ai_whichkey(opts)
        end)
      end)
    end,
  },
  ...
  -- while editing your Neovim configuration.
  {
    ...
    opts = {
      library = {
        ...
        { path = "NikaVim", words = { "NikaVim" } },
        { path = "snacks.nvim", words = { "Snacks" } },
        { path = "lazy.nvim", words = { "NikaVim" } },
