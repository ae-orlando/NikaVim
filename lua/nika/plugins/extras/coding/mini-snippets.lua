if nika_docs then
  ...
  vim.g.nika_mini_snippets_in_completion = true
...
local include_in_completion = vim.g.nika_mini_snippets_in_completion == nil
  or vim.g.nika_mini_snippets_in_completion
...
return {
  ...
  desc = "Manage and expand snippets (alternative to Luasnip)",
  {
    ...
    opts = function()
      ...
      NikaVim.cmp.actions.snippet_stop = function() end -- by design, <esc> should not stop the session!
      ---@diagnostic disable-next-line: duplicate-set-field
      NikaVim.cmp.actions.snippet_forward = function()
        return jump("next")
      end
