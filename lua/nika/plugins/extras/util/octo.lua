return {
  ...
  { import = "nika.plugins.extras.lang.git" },
  ...
  -- Octo Picker
  {
    ...
    opts = function(_, opts)
      ...
      if NikaVim.has_extra("editor.telescope") then
        opts.picker = "telescope"
      elseif NikaVim.has_extra("editor.fzf") then
        opts.picker = "fzf-lua"
      elseif NikaVim.has_extra("editor.snacks_picker") then
        opts.picker = "snacks"
      else
        NikaVim.error("`octo.nvim` requires `telescope.nvim` or `fzf-lua` or `snacks.nvim`")
      end
