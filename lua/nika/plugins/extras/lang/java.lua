...
return {
  ...
  -- Set up nvim-jdtls to attach to java files.
  {
    ...
    opts = function()
      ...
      if NikaVim.has("mason.nvim") then
    ...
    config = function(_, opts)
      ...
      if NikaVim.has("mason.nvim") then
        ...
        if opts.dap and NikaVim.has("nvim-dap") and mason_registry.is_installed("java-debug-adapter") then
      ...
      local function attach_jdtls()
        ...
        local config = extend_or_override({
          ...
          capabilities = NikaVim.has("blink.cmp") and require("blink.cmp").get_lsp_capabilities() or NikaVim.has(
            "cmp-nvim-lsp"
