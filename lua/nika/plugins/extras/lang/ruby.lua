if nika_docs then
  ...
  vim.g.nika_ruby_lsp = "ruby_lsp"
  vim.g.nika_ruby_formatter = "rubocop"
end

local lsp = vim.g.nika_ruby_lsp or "ruby_lsp"
local formatter = vim.g.nika_ruby_formatter or "rubocop"
