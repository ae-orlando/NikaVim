return {
  ...
  -- their results via the `vim.diagnostic` module.
  {
    ...
    opts = {
      ...
      -- NikaVim extension to easily override linter options
      -- or add custom linters.
      ---@type table<string,table>
      linters = {
        -- -- Example of using selene only when a selene.toml file is present
        -- selene = {
        --   -- `condition` is another NikaVim extension that allows you to
    ...
    config = function(_, opts)
      ...
      function M.lint()
        ...
        names = vim.tbl_filter(function(name)
          ...
          if not linter then
            NikaVim.warn("Linter not found: " .. name, { title = "nvim-lint" })
          end
