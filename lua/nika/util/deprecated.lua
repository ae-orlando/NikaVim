...
M.moved = {
  ...
  ui = {
    ...
    foldexpr = { "NikaVim.treesitter.foldexpr", stacktrace = false },
    fg = {
...
function M.decorate(name, mod)
  ...
  return setmetatable(mod, {
    __call = function(_, ...)
      ...
      NikaVim.deprecate("NikaVim." .. name, to)
    ...
    __index = function(_, k)
      if M.moved[name][k] then
        ...
        NikaVim.deprecate("NikaVim." .. name .. "." .. k, to, {
...
function M.lazygit()
  NikaVim.deprecate("NikaVim.lazygit", "Snacks.lazygit")
...
function M.toggle()
  NikaVim.deprecate("NikaVim.toggle", "Snacks.toggle")
  return {
    map = function() end,
    wrap = function()
      return {}
