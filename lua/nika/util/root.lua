...
function M.info()
  ...
  lines[#lines + 1] = "```"
  NikaVim.info(lines, { title = "NikaVim Roots" })
...
function M.setup()
  vim.api.nvim_create_user_command("LazyRoot", function()
    NikaVim.root.info()
  end, { desc = "NikaVim roots for the current buffer" })
  ...
  vim.api.nvim_create_autocmd({ "LspAttach", "BufWritePost", "DirChanged", "BufEnter" }, {
    group = vim.api.nvim_create_augroup("nika_root_cache", { clear = true }),
...
function M.get(opts)
  ...
  return NikaVim.is_win() and ret:gsub("/", "\\") or ret
end
