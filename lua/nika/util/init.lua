...
---@class nika.util: LazyUtilCore
---@field config NikaVimConfig
---@field treesitter nika.util.treesitter
---@field lsp nika.util.lsp
---@field root nika.util.root
---@field terminal nika.util.terminal
---@field format nika.util.format
---@field plugin nika.util.plugin
---@field extras nika.util.extras
---@field inject nika.util.inject
---@field news nika.util.news
---@field json nika.util.json
---@field lualine nika.util.lualine
---@field mini nika.util.mini
---@field pick nika.util.pick
---@field cmp nika.util.cmp
---@field deprecated nika.util.deprecated
local M = {}
M.deprecated = require("nika.util.deprecated")
...
function M.has_extra(extra)
  local Config = require("nika.config")
  local modname = "nika.plugins.extras." .. extra
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "NikaVim"
...
-- Safe wrapper around snacks to prevent errors when NikaVim is still installing
...
function M.set_default(option, value)
  ...
  local g = NikaVim.config._options[option] or vim.api.nvim_get_option_value(option, { scope = "global" })
